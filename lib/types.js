...
var sExpr = function sExpr(func, args) {
  ...
  return {
    ...
    args: args.map(function (arg) {
      return { type: 'Literal', value: parseInt(arg) };
    }),
    chain: function chain(f) {
      return f;
    },
...
var sExprToAstNode = function sExprToAstNode(sExprNode) {
  return sExprNode;
};
...
var ast = function ast(sExpr) {
  var right = sExpr.args;
  var left = { type: sExpr.type, value: sExpr.func };
  var funcNode = astNode(left, right);
